...
[![Build Status](https://github.com/lirantal/cron-to-quartz/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/lirantal/cron-to-quartz/actions?workflow=main)
